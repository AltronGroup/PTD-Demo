...
public class DeviceInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDevice = urovoManager.getDeviceManager();
        ...
        SNKey.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "OS does not implement this method!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        enableHomeKey.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "Enable success", Toast.LENGTH_SHORT).show();
                } catch (NoSuchMethodError e) {
                    Toast.makeText(getApplicationContext(), "OS does not implement this method!", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        disableHomeKey.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "Disable success", Toast.LENGTH_SHORT).show();
                } catch (NoSuchMethodError e) {
                    Toast.makeText(getApplicationContext(), "OS does not implement this method!", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        setAPNKey.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "Setting up China Unicom APN", Toast.LENGTH_SHORT).show();
                    */
                    /*
                    mDevice.setAPN("Telecom", "ctnet", null, 0, "ctnet@mycdma.cn",null, "vnet.mobi", null, "460", "03", null,0, 3, "default,hipri", "IP", 0, "IP", true);
                    Toast.makeText(getApplicationContext(), "Set up China Telecom APN", Toast.LENGTH_SHORT).show();
                    */
                    boolean ret = mDevice.setAPN("中国移动NET设置", "cmnet", null, 0, "none", null, "none", null, "460", "02", null, 0, 0, "default,supl,dun", null, 0, null, true);
                    if (ret) {
                        Toast.makeText(getApplicationContext(), "Set up China Mobile APN", Toast.LENGTH_SHORT).show();
                    } else {
